...
namespace WingProcedural
{
    ...
    public class WingProcedural : PartModule, IPartCostModifier, IPartSizeModifier, IPartMassModifier
    {
        ...
        private static readonly string LOC_Length = Localizer.Format("#B9_Aero_Wing_Procedural_Length"); // "Length"
        private static readonly string LOC_WidthRoot = Localizer.Format("#B9_Aero_Wing_Procedural_WidthRoot"); // "Width (root)"
        private static readonly string LOC_WidthTip = Localizer.Format("#B9_Aero_Wing_Procedural_WidthTip"); // "Width (tip)"
        private static readonly string LOC_OffsetRoot = Localizer.Format("#B9_Aero_Wing_Procedural_OffsetRoot"); // "Offset (root)"
        private static readonly string LOC_OffsetTip = Localizer.Format("#B9_Aero_Wing_Procedural_OffsetTip"); // "Offset (tip)"
        private static readonly string LOC_ThicknessRoot = Localizer.Format("#B9_Aero_Wing_Procedural_ThicknessRoot"); // "Thickness (root)"
        private static readonly string LOC_ThicknessTip = Localizer.Format("#B9_Aero_Wing_Procedural_ThicknessTip"); // "Thickness (tip)"
        private static readonly string LOC_EdgeType = Localizer.Format("#B9_Aero_Wing_Procedural_EdgeType"); // "Shape"
        private static readonly string LOC_PropertyEditor = Localizer.Format("#B9_Aero_Wing_Procedural_PropertyEditor"); // "Property editor"
        private static readonly string LOC_CloseBtn = Localizer.Format("#B9_Aero_Wing_Procedural_CloseBtn"); // "Close"
        private static readonly string LOC_Base = Localizer.Format("#B9_Aero_Wing_Procedural_String_Base"); // "Base"
        private static readonly string LOC_Edgeleading = Localizer.Format("#B9_Aero_Wing_Procedural_String_Edgeleading"); // "Edge (leading)"
        private static readonly string LOC_Edgetrailing = Localizer.Format("#B9_Aero_Wing_Procedural_String_EdgeTrailing"); // "Edge (trailing)"
        private static readonly string LOC_SurfaceTop = Localizer.Format("#B9_Aero_Wing_Procedural_String_SurfaceTop"); // "Surface (top)" 
        private static readonly string LOC_SurfaceBottom = Localizer.Format("#B9_Aero_Wing_Procedural_String_SurfaceBottom"); // "Surface (bottom)"
        private static readonly string LOC_SurfaceTE = Localizer.Format("#B9_Aero_Wing_Procedural_String_SurfaceTE"); // "Surface (trailing edge)"
        private static readonly string LOC_SurfaceLE = Localizer.Format("#B9_Aero_Wing_Procedural_String_SurfaceLE"); // "Surface (leading edge)"
        private static readonly string LOC_Material = Localizer.Format("#B9_Aero_Wing_Procedural_MaterialST"); // "Material"
        private static readonly string LOC_Opacity = Localizer.Format("#B9_Aero_Wing_Procedural_ColorST_Opacity"); // "Opacity"
        private static readonly string LOC_Hue = Localizer.Format("#B9_Aero_Wing_Procedural_String_Hue"); // "Hue"
        private static readonly string LOC_Saturation = Localizer.Format("#B9_Aero_Wing_Procedural_String_Saturation"); // "Saturation"
        private static readonly string LOC_Brightness = Localizer.Format("#B9_Aero_Wing_Procedural_String_Brightness"); // "Brightness"
        private static readonly string LOC_Hint = Localizer.Format("#B9_Aero_Wing_Procedural_Hint"); // "Press J to exit edit mode\nOptions below allow you to change default values"
        private static readonly string LOC_Hint2 = Localizer.Format("#B9_Aero_Wing_Procedural_Hint2"); // "Options options allow you to match the part properties to it's parent"
        private static readonly string LOC_Hint3 = Localizer.Format("#B9_Aero_Wing_Procedural_Hint3"); // "Press J while pointing at a\nprocedural part to edit it"
        private static readonly string LOC_NextTank = Localizer.Format("#B9_Aero_Wing_Procedural_String_NextTank"); // "| Next tank setup"
        private static readonly string LOC_btnDefault = Localizer.Format("#B9_Aero_Wing_Procedural_SaveAsDefault"); // "Save as default"
        private static readonly string LOC_btnRestore = Localizer.Format("#B9_Aero_Wing_Procedural_RestoreDefault"); // "Restore default"
        private static readonly string LOC_Edges = Localizer.Format("#B9_Aero_Wing_Procedural_String_Edges"); // "Edges"
        private static readonly string LOC_Color = Localizer.Format("#B9_Aero_Wing_Procedural_String_Color"); // "Color"
        private static readonly string LOC_ExitingEdit = Localizer.Format("#B9_Aero_Wing_Procedural_ExitingEdit"); // "Exiting edit mode..."
        private static readonly string LOC_Invalid = Localizer.Format("#B9_Aero_Wing_Procedural_String_Invalid"); // "Invalid"
        // Some handy bools
        [KSPField]
